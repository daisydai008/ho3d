...
```
HO3D_dataset/HO3D/
├── train/                    # Training sequences (44 sequences)
...
- **Sequence Durations**: 
  - MC sequences: ~20-30 seconds (896-898 frames)
  - GPMF sequences: ~24-36 seconds (1,092 frames)
  - SiBF sequences: ~64 seconds (2,880 frames)
